...
public class TodoAdapterStudy extends RecyclerView.Adapter<TodoAdapterStudy.ViewHolder> {

    private List<StudyTodoModel> todoList;
    private StudyTodoDatabaseHandler db;
    private StudyActivity activity;


    public TodoAdapterStudy(StudyTodoDatabaseHandler db, StudyActivity activity) {
        this.db = db;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.task_layout_study, parent, false);
    ...
    public void onBindViewHolder( final ViewHolder holder, int position) {
        ...
        final StudyTodoModel item = todoList.get(position);
    ...
    public void setTasks(List<StudyTodoModel> todoList) {
        this.todoList = todoList;
        notifyDataSetChanged();
    }

    public void deleteItem(int position) {
        StudyTodoModel item = todoList.get(position);
