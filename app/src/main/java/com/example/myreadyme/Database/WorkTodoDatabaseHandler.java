...
public class WorkTodoDatabaseHandler extends SQLiteOpenHelper {

    private static final int VERSION = 1;
    private static final String NAME = "WorkToDoListDatabase";
    ...
    public WorkTodoDatabaseHandler(Context context) {
    ...
    public void insertTask(WorkTodoModel task){
    ...
    @SuppressLint("Range")
    public List<WorkTodoModel> getAllTasks(){
        List<WorkTodoModel> taskList = new ArrayList<>();
        Cursor cur = null;
        db.beginTransaction();
        try{
            ...
            if(cur != null){
                if(cur.moveToFirst()){
                    do{
                        // Create a WorkTodoModel object and populate it with task data
